...
#### 1. [:diamond_shape_with_a_dot_inside:](#toc) <a name='look_blk'>Смотрим блочные устройства</a>
```
sudo lsblk 
...
#### 2. [:diamond_shape_with_a_dot_inside:](#toc) <a name='create_raid'>Собираем RAID</a>
```
...
#### 3. [:diamond_shape_with_a_dot_inside:](#toc) <a name='conf_file'>Создание конфигурационного файла mdadm.conf</a>
...
#### 4. [:diamond_shape_with_a_dot_inside:](#toc) <a name='create_fs'>Создание файловой системы и монтирование</a>
```
...
#### 5. [:diamond_shape_with_a_dot_inside:](#toc) <a name='break_fix'>Сломать/починить RAID</a>
...
#### 6. [:diamond_shape_with_a_dot_inside:](#toc) <a name='delete_raid'>Как удалить RAID-массив</a>
...
:white_check_mark: _**Задача:** <a name='1'>Собрать GPT раздел, партиций и смонтировать их на диск</a>._


#### 1. [:diamond_shape_with_a_dot_inside:](#toc) <a name='create_gpt'>Создать GPT раздел, пять партиций и смонтировать их на диск</a>
...
:white_check_mark: _**Задача:** <a name='1'>Автоматизация создания RAID1</a>._

#### 8. [:diamond_shape_with_a_dot_inside:](#toc) <a name='creating_automated'>Автоматизация создания RAID1 c Ansible</a>
