...
![image](https://github.com/user-attachments/assets/4c4941ee-8f0d-4643-af4d-7d9f57e13bdf)


### <a name='toc'>Содержание</a>
1. [Собрать RAID 6](#1)
2. [Собрать RAID 6](#2)
3. [Собрать RAID-массив](#create_raid)
4. [Создание конфигурационного файла mdadm.conf](#conf_file)
5. [Создание файловой системы и монтирование](#create_fs)
6. [Сломать/починить RAID-массив](#break_fix)
7. [Удалить RAID-массив](#delete_raid)
8. [Раздел GPT, пять партиций и их смонтирование на диск](#create_gpt)
